...
local random_loot = {
	...
	{ uuid = blk_glass,				chance = 10,	quantity = randomStackAmountAvg10 },
	{ uuid = blk_metalnet,				chance = 35,	quantity = randomStackAmountAvg10 },
	{ uuid = obj_consumable_gas,			chance = 35,	quantity = randomStackAmount5 },
	{ uuid = obj_consumable_battery,		chance = 35,	quantity = randomStackAmount5 },
	...
	{ uuid = obj_consumable_glowstick,		chance = 25,	quantity = randomStackAmount5 },
	{ uuid = obj_resource_cotton,			chance = 5,	quantity = randomStackAmountAvg2 },
...
local random_epicloot = {
	...
	{ uuid = blk_armoredglass,			chance = 20,	quantity = randomStackAmountAvg10 },

	{ uuid = obj_consumable_gas,			chance = 50,	quantity = randomStackAmount10 },
	{ uuid = obj_consumable_battery,		chance = 50,	quantity = randomStackAmount10 },
	...
	{ uuid = obj_consumable_glowstick,		chance = 20,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_resource_cotton,			chance = 5,	quantity = randomStackAmountAvg3 },
	{ uuid = obj_consumable_glue,			chance = 5,	quantity = randomStackAmountAvg3 },
	{ uuid = obj_resource_ember,			chance = 5,	quantity = randomStackAmountAvg3 },
