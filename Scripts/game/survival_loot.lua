...
local random_loot = {
	...
	{ uuid = obj_consumable_chemical,		chance = 70,	quantity = randomStackAmount2 },
	...
	{ uuid = obj_resource_circuitboard,		chance = 25 },
...
local random_epicloot = {
	...
	{ uuid = obj_resource_circuitboard,		chance = 30 },
...
local random_warehouseloot = {
	...
	{ uuid = obj_consumable_component,		chance = 70,	quantity = 5 },
}
...
local loot_tapebot = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_battery,		chance = 1 },
	}
}
...
local loot_farmbot = {
	...
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 2,		quantity = randomStackAmountAvg10 },
	}
}
